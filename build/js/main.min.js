...
/* harmony import */ var _modules_adaptive__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/adaptive */ "./js/modules/adaptive.js");
...
/* harmony import */ var _modules_about_company__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/about-company */ "./js/modules/about-company.js");
/* harmony import */ var _modules_skroll__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/skroll */ "./js/modules/skroll.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_adaptive__WEBPACK_IMPORTED_MODULE_2__["breakpointCheckerMobile"])();
  Object(_modules_adaptive__WEBPACK_IMPORTED_MODULE_2__["breakpointCheckerDesktop"])();
  Object(_modules_mask_phone__WEBPACK_IMPORTED_MODULE_3__["addMaskPhone"])();
  Object(_modules_accordeon__WEBPACK_IMPORTED_MODULE_4__["initAccordeon"])();
  Object(_modules_about_company__WEBPACK_IMPORTED_MODULE_5__["showAboutCompanyMore"])();
  Object(_modules_skroll__WEBPACK_IMPORTED_MODULE_6__["addSmoothSckroll"])();
...
/*!*************************************!*\
  !*** ./js/modules/about-company.js ***!
  \*************************************/
/*! exports provided: showAboutCompanyMore */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "showAboutCompanyMore", function() { return showAboutCompanyMore; });
var aboutCompany = document.querySelector('[data-company]');
var paragraphs = document.querySelectorAll('[data-company="text-more"]');
var paragraphMobileHidden = document.querySelector('[data-company="text-more-mobile"]');
var buttonShowMore = document.querySelector('[data-company="button"]');
var breakpointMobile = window.matchMedia('(max-width:767px)');
var showAboutCompanyMore = function showAboutCompanyMore() {
  if (aboutCompany) {
...
var accordeonTitles = document.querySelectorAll('[data-accordeon] button');
    ...
    accordeonTitles.forEach(function (accordeonTitle) {
      accordeonTitle.addEventListener('click', function (evt) {
        if (evt.target.classList.contains('is-open')) {
          ...
          var _iterator = _createForOfIteratorHelper(accordeonTitles),
            _step;
          try {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "breakpointCheckerMobile", function() { return breakpointCheckerMobile; });
...
var mainBlockLink = document.querySelector('[data-get-consultation-button]');
var productsTitle = document.querySelector('[data-products="title"]');
var cardTitle = document.querySelector('[data-products="link"] h3');
var breakpointMobile = window.matchMedia('(max-width:767px)');
var breakpointDesktop = window.matchMedia('(min-width:1024px)');
var breakpointCheckerMobile = function breakpointCheckerMobile() {
  if (breakpointMobile.matches) {
    if (mainBlockLink) {
...
/*!**********************************!*\
  !*** ./js/modules/mask-phone.js ***!
  \**********************************/
/*! exports provided: addMaskPhone */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addMaskPhone", function() { return addMaskPhone; });
var inputElements = document.querySelectorAll('[data-mask="phone"]');
var addMaskPhone = function addMaskPhone() {
  if (!inputElements) {
    return;
  }
  var phoneOptions = {
